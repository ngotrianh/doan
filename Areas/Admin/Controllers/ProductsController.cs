...
namespace nhom17.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class ProductsController : Controller
    {
        ...
        public ProductsController(Nhom17Context context)
        {
            _context = context;
        }
        ...
        {
            var nhom17Context = _context.TbProducts.Include(t => t.CategoryProduct);
            return View(await nhom17Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Title,Alias,CategoryProductId,Description,Detail,Image,Price,PriceSale,Quantity,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,IsNew,IsBestSeller,UnitInStock,IsActive,Star")] TbProduct tbProduct)
        {
            ...
            {
                tbProduct.Alias = nhom17.Utilities.Function.TitleSlugGenerationAlias(tbProduct.Title);
